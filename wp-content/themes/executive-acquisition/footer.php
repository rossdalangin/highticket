<footer class="site-footer">
    <div class="container footer-grid">
        <div class="footer-brand">
            ...
            <p class="footer-mission"><?php echo esc_html( get_theme_mod('ea_about_mission') ); ?></p>
        ...
        <div class="footer-contact">
            ...
            <p class="contact-info"><strong>Location:</strong> <?php echo esc_html( get_theme_mod('ea_contact_office') ); ?></p>
